...
public class PostService : IPostService
{
    ...
    public async Task<Post> CreateAsync(Guid userId, string title, string content, string image)
    {
    ...
    public async Task<Post?> UpdateAsync(Guid id, string? title, string? content, string? image)
    {
